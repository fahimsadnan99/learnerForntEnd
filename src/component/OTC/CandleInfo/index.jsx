      ...
      <div className="container pb-5">
        ...
        <div>
          <p className="pt-4">
            ...
            ক্যান্ডেলের ভাষা বুঝতে পারা টাই হচ্ছে ক্যান্ডেলের ইনফরমেশন।
          </p>
          <p>
          ...
          <p>
            ট্রেড করার প্রথম উপাদান হলো ক্যান্ডেল,এটাকে আমরা চা পাতা মনে করতে পারি
            চা পাতা ছাড়া আমরা চা বানাতে পারি না, তেমনি ক্যান্ডেল ছাড়া আমরা
            ট্রেডিং করতে পারবো না।
          </p>
          <p>
          একটা ক্যান্ডেল অনেকগুলো ক্যান্ডেলের সমষ্টি বা যোগফল । একটা ১ ঘণ্টা
            ক্যান্ডেলের ভিতরে আমরা ৬০ টা ১ মিনিটের ক্যান্ডেল দেখতে পাব যেহেতে ১
            ঘণ্টা সমান ৬০ মিনিট আর প্রতি মিনিটে ১ টা কেন্ডেল হলে ৬০টা কেন্ডেল
            পাবো এবং ১ মিনিটের ক্যান্ডেলে 5 সেকেন্ডের 12 টা ক্যান্ডেল দেখতে পাবো
            , আমরা খুদ্র সময় ৫ সেকেন্ডের নিছে দেখতে পাই না তাই ৫ সেকেন্ড * ১২ =
            ৬০ সেকেন্ড মানে ১ মিনিট । এর মানে আমরা বুঝতে পারছি যে একটা কেন্ডেল
            এর মাঝে অনেক কেন্ডেল লুকনো আছে আর সে লুকনো কেন্ডেলের ভাষা বুঝতে
            শিখবো আজ আমরা।
          </p>

          <p>
          ১ ঘণ্টার একটা কেন্ডেল সবুজ মানে বায়ার কেন্ডেল হয়েছে মানে ৬০ টা
            ...
            কারণে কেন্ডেলের রঙ সবুজ হয়েছে যাকে আমরা বুল কেন্ডেল বা বুলিশ হিসেবে
            জানি। তেমনি ১ মিনিটের কেন্ডেলে ৫ সেকেন্ডের ১২ টা কেন্ডেল হয়েছে তার
            মধ্যে ৪ টা লাল আর ৮ তা সবুজ হয়েছে মনে করি এর মানে সবুজ বেশী এর কারণে
            কেন্ডেল হবে সবুজ।
            নিচে চিত্রের মাধ্যমে আমরা বুঝার চেষ্টা করবো...
          </p>
